...
def getFrameRange():
    ...
    '''
    start_time = int(input('Enter starting time [mmss]: '))
    end_time = int(input('Enter ending time [mmss]: '))


    start_second = (start_time % 100) + (start_time // 100) * 60
    end_second = (end_time % 100) + (end_time // 100) * 60
